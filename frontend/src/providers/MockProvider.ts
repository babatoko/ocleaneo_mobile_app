  ...
  return [
    {
      ...
      latitude: chantiers[0].latitude,
      longitude: chantiers[0].longitude,
    ...
    },
    {
      ...
      latitude: chantiers[1].latitude,
      longitude: chantiers[1].longitude,
    ...
    },
    {
      ...
      latitude: chantiers[3].latitude,
      longitude: chantiers[3].longitude,
    ...
    // Mercredi
    {
      ...
      latitude: chantiers[2].latitude,
      longitude: chantiers[2].longitude,
